	...
	<header id="header"><!--header-->
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
                ...
                <?php } else{?>
                <li><a href="{{ URL::to('/login-check') }}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                <?php }?>
              ...
              <div class="panel panel-default">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <?php
                     $all_publish_cat=DB::table('category')
                                         ...
                                         ->get();
                     foreach($all_publish_cat as $data){?>
                       <li>
										  <a  href="{{ URL::to('/product_by_category/'.$data->category_id) }}">
                  ...
                  <?php
                   $all_publish_manu=DB::table('manufacture')
                               ->where('publication_status',1)
                               ->get();
                   foreach($all_publish_manu as $brand){?>
									<li><a href="{{ URL::to('/product_by_manufacture/'.$brand->manufacture_id) }}">{{$brand->manufacture_name}}</a></li>
                  <?php } ?>
                </ul>
							</div>
						</div><!--/brands_products-->
						...
						<div class="shipping text-center"><!--shipping-->
							<img src="{{URL::to('backend/images/home/shipping.jpg')}}" alt="" />
						</div><!--/shipping-->
