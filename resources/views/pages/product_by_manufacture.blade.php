...
@section('content')
  ...
  <h2 class="title text-center">Features Items</h2>
    <?php foreach($product_by_manufacture as $brand){?>
  <div class="col-sm-4">
    <div class="product-image-wrapper">
      <div class="single-products">
          <div class="productinfo text-center">
            <img src="{{URL::to( $brand->product_image)}}" style="height: 300px" alt="" />
            <h2>{{ $brand->product_price }}</h2>
      ...
      <div class="choose">
        <ul class="nav nav-pills nav-justified">
          <li><a href="#"><i class="fa fa-plus-square"></i>{{$brand->manufacture_name}}</a></li>
