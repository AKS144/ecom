...
@section('content')
  ...
  <h2 class="title text-center">Features Items</h2>
    <?php foreach($all_pub_prod as $product){?>
  <div class="col-sm-4">
    <div class="product-image-wrapper">
      <div class="single-products">
          <div class="productinfo text-center">
            <img src="{{URL::to( $product->product_image)}}" style="height: 300px" alt="" />
      ...
      <div class="choose">
        <ul class="nav nav-pills nav-justified">
          <li><a href="#"><i class="fa fa-plus-square"></i>Add to wishlist</a></li><!--added link to -->
